...
| Q-002 | Which users receive Live Activity? | Authenticated users who follow/subscribe to the match and have eligible device/platform state. User does not need to currently be in Match Detail/Player screen. |
